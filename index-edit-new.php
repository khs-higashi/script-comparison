...
<main>
    <section class="w1200">
        ...
        <form method="post" action="index-edit-process.php" class="edit-form" id="script-form">
            ...
            <input type="hidden" name="save_as_new_version" id="save_as_new_version" value="0">
            <input type="hidden" name="sync_kouban" id="sync_kouban" value="0">
            ...
            <div class="script-editor-container">
                ...
                <div class="script-main">
                            ...
                            <div class="script-menu-item">
                                ...
                                <div class="script-dropdown">
                                    ...
                                    <div class="script-dropdown-item" id="menuViewLineNumber">
                                        ...
                                        <div class="script-submenu">
                                            <div class="script-submenu-item" id="menuViewLineNumberContinuous">
                                                <span>連続番号</span>
                                            </div>
                                            <div class="script-submenu-item" id="menuViewLineNumberScene">
                                                <span>シーンごと番号</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="script-toolbar">
                        ...
                        <!-- 検索・置換機能 -->
                        <input type="text" id="searchInput" placeholder="検索..." class="script-search-input">
                        <button type="button" class="script-tool-btn" title="検索" id="toolSearch"><i class="fa-solid fa-search"></i></button>
                        <button type="button" class="script-tool-btn" title="置換" id="toolReplace"><i class="fa-solid fa-exchange-alt"></i></button>
                    </div>
                    ...
                    <div class="script-editor-content">
                        <div class="script-line-numbers-container">
                            ...
                            <div class="script-line-numbers script-line-numbers-cut" id="scriptLineNumbersCut" style="display: none;"></div>
                        </div>
                        <div class="script-edit-area" id="scriptEditArea" contenteditable="true">
                            ...
                            <div class="script-scene" data-scene-index="0">
                                <div class="scriptarea-hashira">
                                    <div class="script-hashira-id" contenteditable="false">001</div>
                            ...
                            <div class="script-scene" data-scene-index="<?php echo $index; ?>">
                                <div class="scriptarea-hashira">
                                    <div class="script-hashira-id" contenteditable="false"><?php echo htmlspecialchars($scene['scene_id']); ?></div>
                                    <div class="script-hashira-content">
                                        <div class="script-hashira-location-row">
                                ...
                                <div class="scene-layout">
                                    ...
                                    <div class="scene-right">
                                        ...
                                        <?php elseif ($item['type'] === 'edit_mark'): ?>
                                        <span class="script-edit-mark" contenteditable="true"><?php echo htmlspecialchars($item['text']); ?></span>
                                        <?php elseif ($item['type'] === 'cut_mark'): ?>
                                        <div class="script-cut-mark" contenteditable="true" data-cut-id="<?php echo htmlspecialchars($item['cut_id'] ?? ''); ?>"><br class="cut-wari"><?php echo htmlspecialchars($item['description'] ?? ''); ?></div>
                                        <?php endif; ?>
        ...
        <!-- 香盤情報登録モーダル -->
        <div id="kouban-register-modal" class="modal">
            <div class="modal-content">
                <span class="close-modal">&times;</span>
                <h3>香盤情報登録</h3>
                <div class="kouban-selection">
                    <div class="form-group">
                        <label for="kouban-type">香盤タイプ:</label>
                        <select id="kouban-type" class="form-control">
                    ...
                    <div class="form-group">
                        <label for="kouban-name-jp">日本語名称:</label>
                        <input type="text" id="kouban-name-jp" class="form-control" placeholder="例: #白雪姫のりんご">
                    </div>
                    
                    <div class="form-group">
                        <label for="kouban-name-en">英数字名称:</label>
                        <input type="text" id="kouban-name-en" class="form-control" placeholder="例: #apple-of-princess">
                    </div>
                    
                    <div class="selected-text-preview">
                        <h4>選択したテキスト:</h4>
                        <div id="selected-text-content" class="selected-text-box"></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" id="register-kouban-btn" class="btn">登録</button>
        ...
        <!-- カット割り登録モーダル -->
        <div id="cut-mark-modal" class="modal">
            <div class="modal-content">
                <span class="close-modal">&times;</span>
                <h3>カット割り登録</h3>
                <div class="form-group">
                    <label for="cut-description">カット説明:</label>
                    <input type="text" id="cut-description" class="form-control" placeholder="例: 主人公を肩越し">
                </div>
                <div class="modal-footer">
                    <button type="button" id="register-cut-btn" class="btn">登録</button>
        ...
        <div id="replace-modal" class="modal">
            <div class="modal-content">
                ...
                <div class="form-group">
                    <label for="replace-text">置換後:</label>
                    <input type="text" id="replace-text" class="form-control">
                </div>
                <div class="modal-footer">
                    <button type="button" id="replace-single-btn" class="btn">個別置換</button>
                    <button type="button" id="replace-all-btn" class="btn">まとめて置換</button>
                    <button type="button" class="cancel-btn btn">キャンセル</button>
                </div>
            </div>
        </div>
        ...
        <!-- PDF出力設定モーダル -->
        <div id="pdf-settings-modal" class="modal">
            <div class="modal-content">
                <span class="close-modal">&times;</span>
                <h3>PDF保存設定</h3>
                <div class="form-group">
                    <label for="pdf-orientation">文字組:</label>
                ...
                <div class="form-group">
                    <label for="pdf-layout">レイアウト:</label>
                    <select id="pdf-layout" class="form-control">
                        <option value="a4-portrait">A4縦</option>
                        <option value="b5-portrait">B5縦</option>
                        <option value="script-portrait">台本サイズ縦</option>
                        <option value="a4-landscape">A4横</option>
                        <option value="b5-landscape">B5横</option>
                        <option value="script-landscape">台本サイズ横</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="pdf-font-size">文字サイズ:</label>
                    <select id="pdf-font-size" class="form-control">
                        <option value="small">小さく(0.8em)</option>
                        <option value="medium" selected>標準</option>
                        <option value="large">大きく(1.2em)</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="pdf-line-height">行間:</label>
                    <select id="pdf-line-height" class="form-control">
                        <option value="small">狭く(0.8em)</option>
                        <option value="medium" selected>標準</option>
                        <option value="large">広く(1.2em)</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="pdf-color">色:</label>
                    <select id="pdf-color" class="form-control">
                        <option value="mono">モノクロ</option>
                        <option value="color">カラー</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="pdf-font-family">書体:</label>
                    <select id="pdf-font-family" class="form-control">
                        <option value="mincho">明朝</option>
                        <option value="gothic">ゴシック</option>
                        <option value="maru-gothic">丸ゴシック</option>
                    </select>
                </div>
                <div class="modal-footer">
                    <button type="button" id="generate-pdf-btn" class="btn">PDF作成</button>
                    <button type="button" class="cancel-btn btn">キャンセル</button>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 要素が存在するか確認
    console.log('Menu bar:', document.querySelector('.script-menu-bar'));
    console.log('Editor area:', document.querySelector('.script-edit-area'));
    console.log('Script loaded check');
});
</script>

<script>
window.initialScenes = <?php echo json_encode($scenes ?? [], JSON_UNESCAPED_UNICODE); ?>;
window.workId = <?php echo json_encode($work_id ?? ''); ?>;
window.scriptId = <?php echo json_encode($script_id ?? ''); ?>;
window.scriptCharacters = <?php echo json_encode($characters ?? [], JSON_UNESCAPED_UNICODE); ?>;
window.isEditMode = <?php echo json_encode((bool)($edit_mode ?? false)); ?>;
window.scriptVersion = <?php echo json_encode((int)($version ?? 1)); ?>;
window.isFinal = <?php echo json_encode(isset($script) && is_array($script) && ($script['is_final'] ?? 0) == 1); ?>;
</script>
